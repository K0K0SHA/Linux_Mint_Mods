...
# FILE MODIFIED BY THE LEGENDARY HACKER K0K0$H@
...
# increase for more (further back) History but also more resource use
HISTSIZE=1000
HISTFILESIZE=2000
...
echo "Welcome to K0K0\$H@'s Customized Shell!"
cd ~
echo "Home Directory(~):" 
pwd
date

echo "Setting aliases...\nFor more info on aliases, use alias --help and alias -l\n" 
shopt -s expand_aliases  # for session persistence
alias cls='clear' 
alias dir='ls -a' 
